'use strict'
const Data = use('App/Model/Group')  // EDIT
const Antl = use('Antl')
...
class GroupController{
  constructor () {
      this.type = ""  // EDIT
      this.key = "group"  // EDIT
      this.menu = "pos_group"  // EDIT
      this.download = "Group.xlsx"  // EDIT
      this.barcode = "BARCODE_GROUP"
      this.room = "group"  // EDIT
    }
  * show (request, response){
      const title = Antl.formatMessage('group.title')  // EDIT
      const data = yield Data.query().orderBy('id', 'desc').fetch()
      const show = yield response.view('pos/pages/group', {key : this.key ,room : this.room ,title: title , data: data.toJSON()})  // EDIT
      response.send(show)
  }
