...
class ReceiptInventoryVoucherController{
  constructor () {
      this.type = 1  // EDIT Receipt = 1 , Issue = 2 , Transfer = 3
      this.key = "receipt-inventory-voucher"  // EDIT
      this.menu = "pos_receipt_inventory_voucher"
      this.voucher = 'INVENTORY_RECEIPT_%'
      this.print = 'PNK%'
      this.room = "inventory-voucher"  // EDIT
    }

    * show (request, response){
        const title = Antl.formatMessage('receipt_inventory_voucher.title')  // EDIT
        ...
        const show = yield response.view('pos/pages/receipt_inventory_voucher', {key : this.key ,title: title , voucher : voucher, item : item.toJSON() , print : print.toJSON()})  // EDIT
        response.send(show)
    }
...
module.exports = ReceiptInventoryVoucherController
