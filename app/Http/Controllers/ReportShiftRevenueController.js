...
class ReportShiftRevenueController{
  ...
  * show (request, response){
      ...
      const show = yield response.view('pos/pages/report_shift_revenue', {key : this.key ,room : this.room,title: title , end_date:end_date , shift_list : shift.toJSON() , stock: stock.toJSON()})  // EDIT
      response.send(show)
  }
