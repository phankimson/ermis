'use strict'
const Data = use('App/Model/WarrantyPeriod')  // EDIT
const Antl = use('Antl')
...
class WarrantyPeriodController{
  constructor () {
      this.type = ""  // EDIT
      this.key = "warranty-period"  // EDIT
      this.menu = "pos_warranty_period"  // EDIT
      this.download = "WarrantyPeriod.xlsx"  // EDIT
      this.room = "warranty-period"  // EDIT
    }
  * show (request, response){
      const title = Antl.formatMessage('warranty_period.title')  // EDIT
      const data = yield Data.query().orderBy('id', 'desc').fetch()
      const show = yield response.view('pos/pages/warranty_period', {key : this.key ,room : this.room,title: title , data: data.toJSON()})  // EDIT
      response.send(show)
  }
...
module.exports = WarrantyPeriodController
