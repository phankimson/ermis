...
class ReportGeneralRevenueController{
  ...
  * show (request, response){
      ...
      const show = yield response.view('pos/pages/report_general_revenue', {key : this.key ,room : this.room,title: title , end_date:end_date , start_date :start_date , stock: stock.toJSON()})  // EDIT
      response.send(show)
  }
