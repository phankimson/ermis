'use strict'
const Data = use('App/Model/Origin')  // EDIT
const Antl = use('Antl')
...
class OriginController{
  constructor () {
      this.type = ""  // EDIT
      this.key = "origin"  // EDIT
      this.menu = "pos_origin"  // EDIT
      this.download = "Origin.xlsx"  // EDIT
      this.barcode = "BARCODE_ORIGIN"
      this.room = "origin"  // EDIT
    }
  * show (request, response){
      const title = Antl.formatMessage('origin.title')  // EDIT
      const data = yield Data.query().orderBy('id', 'desc').fetch()
      const show = yield response.view('pos/pages/origin', {key : this.key ,room : this.room ,title: title , data: data.toJSON()})  // EDIT
      response.send(show)
  }
