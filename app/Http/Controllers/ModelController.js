'use strict'
const Data = use('App/Model/Model')  // EDIT
const Antl = use('Antl')
...
class ModelController{
  constructor () {
      this.type = ""  // EDIT
      this.key = "model"  // EDIT
      this.menu = "pos_model"  // EDIT
      this.download = "Model.xlsx"  // EDIT
      this.barcode = "BARCODE_MODEL"
      this.room = "model"  // EDIT
    }
  * show (request, response){
      const title = Antl.formatMessage('model.title')  // EDIT
      const data = yield Data.query().orderBy('id', 'desc').fetch()
      const show = yield response.view('pos/pages/model', {key : this.key ,room : this.room ,title: title , data: data.toJSON()})  // EDIT
      response.send(show)
  }
